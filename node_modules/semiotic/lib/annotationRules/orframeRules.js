...
function arcBracket(_ref) {
  ...
  var d = void 0;
  if (curly) {
    var middleLeft = polarToCartesian(x, y, radius + outset, (startAngle + endAngle) / 2 + 10);

    var middle = polarToCartesian(x, y, radius + outset + 10, (startAngle + endAngle) / 2);
    var middleRight = polarToCartesian(x, y, radius + outset, (startAngle + endAngle) / 2 - 10);

    d = ["M", innerStart.x, innerStart.y, "L", start.x, start.y, "A", radius + outset, radius + outset, 0, largeArcFlag, 0, middleLeft.x, middleLeft.y, "A", radius + outset, radius + outset, 1, largeArcFlag, 1, middle.x, middle.y, "A", radius + outset, radius + outset, 1, largeArcFlag, 1, middleRight.x, middleRight.y, "A", radius + outset, radius + outset, 0, largeArcFlag, 0, end.x, end.y, "L", innerEnd.x, innerEnd.y].join(" ");
  } else {
    var _middle = polarToCartesian(x, y, radius + outset, (startAngle + endAngle) / 2);
